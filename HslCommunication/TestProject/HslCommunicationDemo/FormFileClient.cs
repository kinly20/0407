...
namespace HslCommunicationDemo
{
    public partial class FormFileClient : Form
    {
        ...
        private void FillNodeByFactoryGroupId( TreeNode root, string factory, string group, string id, int grade )
        {
            root.Nodes.Clear( );
            string[] folders;
            OperateResult read = integrationFileClient.DownloadPathFolders( out  folders, factory, group, id );
            if (read.IsSuccess)
            {
        ...
        private void FillNodeFilesByFactoryGroupId( TreeNode root, string factory, string group, string id )
        {
            root.Nodes.Clear( );
            GroupFileItem[] files;
            OperateResult read = integrationFileClient.DownloadPathFileNames( out  files, factory, group, id );
            if (read.IsSuccess)
            {
