...
namespace SFServer
{
    public class HTTP
    {
        ...
        #region 设立任务
        public static string SetOrder(string locationfrom, string locationto, string armGroup)
        {
            try
            {
                ...
                if (from != "")//找到来源房间
                {
                    ...
                    {
                        string taskid = SetOrderNew1(from.Replace("功能间", ""), locationto, armGroup);//功能间去生产点
                        if (taskid == null)
                            taskid = "";
                        return taskid;//已有
                    }
                    ...
                    {
                        string taskid = SetOrderNew2(from.Replace("备用间", ""), locationto, armGroup);//备用间去生产点
                        if (taskid == null)
                            taskid = "";
                        return taskid;
                    }
                ...
                else if (to != "")
                {
                    if (to.IndexOf("功能间") >= 0)
                    {
                        string taskid = SetOrderNew3(locationfrom, to.Replace("功能间", ""), armGroup);//生产点去功能间
                        if (taskid == null)
                            taskid = "";
                        return taskid;
                    }
                    ...
                    {
                        string taskid = SetOrderNew4(locationfrom, to.Replace("备用间", ""), armGroup);//生产点去备用间
                        if (taskid == null)
                            taskid = "";
                        return taskid;
                    }
        ...
        public static string SetOrderNew1(string locationfrom, string locationto, string armGroup)
        {
            string url = "http://" + agvip + ":" + agvport + "/script-api/orderGroupToSite";

            if (armGroup.Substring(0, 1).ToUpper() != "G")
                url += "1";
            ...
            if (back != null)
            {
                try
                {
                    ...
                    //Log.writelog("下单成功" + url + postDataStr);
        ...
        /// <param name="locationfrom"></param>
        /// <param name="locationto"></param>
        public static string SetOrderNew2(string locationfrom, string Groupto, string armGroup)
        {
        ...
        /// <param name="locationfrom"></param>
        /// <param name="locationto"></param>
        public static string SetOrderNew3(string locationfrom, string Groupto, string armGroup)
        {
        ...
        /// <param name="locationfrom"></param>
        /// <param name="locationto"></param>
        public static string SetOrderNew4(string locationfrom, string Groupto, string armGroup)
        {
        ...
        public static string Getsitename(int locked, int filled, string groupname)
        {
            groupname = groupname.Replace("功能间", "").Replace("备用间", "");
            string url = "http://" + agvip + ":" + agvport + "/api/work-sites/sites";
            ...
            if (back != null)
            {
                try
                {
                    siteinfo regUnLockInputDto = JsonConvert.DeserializeObject<siteinfo>(back);
                    if (regUnLockInputDto.data.Count > 0)
                        return regUnLockInputDto.data[0].siteId;
                }
                catch (Exception ex)
                {
                    return "";
        ...
        public static bool Getsitestatus(string bingroupname)
        {
            string url = "http://" + agvip + ":" + 8088 + "/binDetails?binGroups=" + bingroupname;
            ...
            if (back != null)
            {
                ...
                {
                    functionsiteparam regUnLockInputDto = JsonConvert.DeserializeObject<functionsiteparam>(back);
                    if (regUnLockInputDto.groupStatus == 0)
                        return true;
                }
                catch (Exception ex)
                {
