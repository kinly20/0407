...
using Mode= DRsoft.Modeling.Metadata.Models;

namespace DRsoft.Modeling.Metadata.Managers
{
    internal class ControllerManager: BaseManager<ControlConfig>, IMetadataManager
    {
        /// <summary>
        /// 实例
        /// </summary>
        private static volatile ControllerManager s_Instance;
        ...
        public override Guid Insert(ControlConfig metadata)
        {
        ...
        public override void Update(ControlConfig metadata)
        {
            // 更新最后修改人，最后修改时间
            metadata.ModifiedBy = CurrentUserName;
            metadata.ModifiedOn = Clock.Now;
        ...
        public void Update(string jsonData, bool isSubmit)
        {
            ...
            ControlConfig metadata = JsonConvert.DeserializeObject<ControlConfig>(jsonData, JsonSetting);
            Update(metadata);
        }
        ...
        public void CheckOut(Guid metadataId)
        {
            ...
            {
                // 签出运行时文件，生成设计时文件
                ControlConfig metadata = FileOperator.CheckOut(metadataId);
                // 刷新二开运行时
                ControlConfig runtimeMetadata = metadata.Clone();
                // 更新运行时缓存
        ...
        /// <returns></returns>
        public override MetadataStatusItem GetStatusItem(ControlConfig metadata, StatusType status)
        {
