    ...
    public class PLC
    {
        ...
        private void ModbusTcpHsl_Communicate()
        {
            while (true)
            {
                ...
                {
                    //System.Windows.MessageBox.Show("链接不通！");
                }
                Thread.Sleep(200);
            }
        }
        ...
        private void NoReadAddrMessage()
        {
            ...
            Mode.Add("1");
            StartAddr.Add(int.Parse(addr1.Split('.')[0]));
            AddrLenght.Add(1);

            Mode.Add("1");
            StartAddr.Add(int.Parse(addr2.Split('.')[0]));
            AddrLenght.Add(1);

            Mode.Add("1");
            StartAddr.Add(int.Parse(addr3.Split('.')[0]));
            AddrLenght.Add(1);

            Mode.Add("1");
            StartAddr.Add(int.Parse(addr6.Split('.')[0]));
            AddrLenght.Add(1);
            ...
            //Mode.Add("1");
            //StartAddr.Add(int.Parse(addr4.Split('.')[0]));
            //AddrLenght.Add(1);
            ...
            //Mode.Add("1");
            //StartAddr.Add(int.Parse(addr5.Split('.')[0]));
            //AddrLenght.Add(1);
